                ...
                <form class="search_form" action="<?php echo $action; ?>" method="get">
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-hover dataTable" role="grid">
                            ...
                            <tr class="searchbar">
                                <th><input type="text" class="search_input form-control" name="pdr_sn" value="<?php echo $filter['pdr_sn']; ?>" /></th>
                                <th><input type="text" class="search_input form-control" name="mobile" value="<?php echo $filter['mobile']; ?>" /></th>
                                <th><input type="text" class="search_input form-control" name="pdr_amount" value="<?php echo $filter['pdr_amount']; ?>" /></th>
                                <th>
                                    <select class="search_input form-control" name="pdr_type">
                                ...
                                <th>
                                    <select class="search_input form-control" name="pdr_payment_state">
                                        <option value>全选</option>
                                ...
                                <th><input type="text" class="search_input form-control" name="pdr_admin" value="<?php echo $filter['pdr_admin']; ?>" /></th>
                                <th><input type="text" class="search_input form-control date-range" name="pdr_add_time" value="<?php echo $filter['pdr_add_time']; ?>" /></th>
                                <th>
                                    <!--<div class="btn-group">
