...
<section class="content-header">
    <h1>用户信用记录<small>用户信用记录</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-hover dataTable" role="grid">
                            ...
                            <tr class="searchbar">
                                ...
                                <th><input type="text" class="search_input form-control" name="points" value="<?php echo $filter['points']; ?>" /></th>
                                <th><input type="text" class="search_input form-control" name="point_desc" value="<?php echo $filter['point_desc']; ?>" /></th>
