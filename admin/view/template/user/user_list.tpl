...
<section class="content-header clearfix">
    <h1 class="pull-left">
        <span><?php echo $languages['yhgl'];?></span>
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab"><?php echo $languages['yhlb'];?></a></li>
                </ul>
                        ...
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="available_state" class="input-sm">
                                    <option value><?php echo $languages['sfkcc'];?></option>
                                ...
                                <input type="text" name="add_time" value="<?php echo $filter['add_time']; ?>" class="input-sm date-range" style="border: 1px solid #a9a9a9;" placeholder="<?php echo $languages['zcsj'];?>"/>
