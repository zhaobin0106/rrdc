        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab"><?php echo $languages['dcxq'];?></a></li>
                </ul>
                        ...
                        <form class="form-horizontal" method="post">
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    <label for="" class="col-sm-4 control-label"><?php echo $languages['dcbm'];?>:</label>
                                    <div class="col-sm-8" style="margin-top: 7px;">
                                        <span><?php echo $data['bicycle_sn']; ?></span>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="" class="col-sm-4 control-label"><?php echo $languages['dclx'];?>:</label>
                                    <div class="col-sm-8" style="margin-top: 7px;">
                                        <span><?php echo $data['type']; ?></span>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="" class="col-sm-4 control-label"><?php echo $languages['csbh'];?>:</label>
                                    <div class="col-sm-8" style="margin-top: 7px;">
                                        <span><?php echo $data['lock_sn']; ?></span>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="" class="col-sm-4 control-label"><?php echo $languages['zhuangtai'];?>:</label>
                                    <div class="col-sm-8" style="margin-top: 7px;">
