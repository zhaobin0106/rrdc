        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="javascript:;" data-toggle="tab"><?php echo $languages['wzlb'];?></a></li>
                </ul>
                        ...
                        <form class="search_form" id="search_form" action="<?php echo $action; ?>" method="get">
                            ...
                            <div class="dataTables_length fa-border" style="margin: 10px 0; padding: 10px">
                                ...
                                <select name="category_id" class="input-sm">
                                    <option value><?php echo $languages['wzfl'];?></option>
                        ...
                        <form id="table_form" class="table_form" method="post">
                            <table class="table table-bordered table-hover dataTable" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button data-url="<?php echo $data['edit_action']; ?>" type="button" class="btn btn-info link"><i class="fa fa-fw fa-pencil"></i><?php echo $languages['bianji'];?></button>
